...
const playerColorMap: Record<string, { hex: string; glow: string; label: string }> = {
...
export function LobbyPage() {
  ...
  const filledCount = mockPlayers.length;
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <h2 className="font-display text-3xl font-semibold text-text mb-1">Lobby</h2>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isEmpty ? "none" : `0 0 10px 0 ${colorMeta.glow}`,
                    }}
                  />
